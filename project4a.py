...
def draw(c):
    ...
    #print ball_pos[0]-PAD_WIDTH - BALL_RADIUS

          
    #print "score1: " + str(score1)
    #print "score2: " + str(score2)    
    c.draw_text(str(score1), [WIDTH/4,HEIGHT/4], 30, "red")
    c.draw_text(str(score2), [WIDTH*3/4,HEIGHT/4], 30, "blue")
    
   
   
def tick():
    global time, score1, score2
    time = time + 1
    #print time
    #print ball_vel
    #print 
